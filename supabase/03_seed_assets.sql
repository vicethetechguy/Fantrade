...
insert into public.assets (id, ticker, name, kind, club, league, position, price, reference_value, reference_at) values
  ...
  ('$Rodri', 'FRODRI', 'Rodri', 'PLAYER', 'Manchester City', 'Premier League', 'MID', 61.30, 61.30, now()),
  ('$Foden', 'FFODN', 'Phil Foden', 'PLAYER', 'Manchester City', 'Premier League', 'FWD', 54.10, 54.10, now()),
  ('$Pedri', 'FPEDRI', 'Pedri González', 'PLAYER', 'Barcelona', 'La Liga', 'MID', 41.15, 41.15, now()),
  ...
  ('$Arteta', 'FARTETA', 'Mikel Arteta', 'COACH', 'Arsenal', 'Premier League', 'MGR', 22.05, 22.05, now()),
