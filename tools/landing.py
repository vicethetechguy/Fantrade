...
.mobile-menu a{
  font-family:Space Grotesk,sans-serif;font-size:clamp(26px,7vw,38px);
...
.anywhere-copy h2{font-size:clamp(28px,4.2vw,52px);font-weight:700;text-transform:none;line-height:1.08;letter-spacing:-.035em}
...
.token{position:relative;display:grid;place-items:center;width:120px;height:138px;flex:none;border-radius:26px;background:linear-gradient(135deg,#4422dd,#1800ad 40%,#FFAE19 75%,#FF6A1F);border:3px solid #5533ee;box-shadow:9px 9px 0 #0a0050,15px 16px 30px rgba(0,0,0,.8),inset 0 0 20px rgba(255,255,255,.5);transform:rotate(-18deg) rotateY(-24deg);color:#fff;font-family:Space Grotesk;font-size:44px;font-weight:900;letter-spacing:-2px}
