...
.clubchip[aria-pressed="true"]{border-color:var(--lime);background:rgba(196,248,42,.08)}
...
.clubchip .rc.plus{background:rgba(196,248,42,.12);color:var(--lime);font-size:17px;
  clip-path:none;border-radius:10px;border:1px dashed rgba(196,248,42,.42)}
...
.clubchip.add .cd{border-left-color:rgba(196,248,42,.25)}
...
.minute{position:absolute;left:50%;bottom:-13px;transform:translateX(-50%);border-radius:999px;padding:6px 15px;
  background:var(--lime);color:#0A0D03;font-family:'Montserrat', sans-serif;font-size:11px;white-space:nowrap;
...
body.app .kc-p-avatar-img{box-shadow:0 8px 24px rgba(0,0,0,.35),0 0 0 4px rgba(196,248,42,.055)!important}
body.app .kc-row:hover,
body.app .kc-item-row:hover{box-shadow:inset 3px 0 0 rgba(196,248,42,.42)}
@media(max-width:768px){
  ...
  var defaultState = {
    ...
    clubs: [
      { id: "c-1", name: "Zero FC", stadium: "Emirates of the North",
        colors: ["#C4F82A", "#83b300"], colorName: "Lime", formation: "4-3-3",
