...
.clubchip .cd{font-family:'JetBrains Mono',monospace;font-size:10px;color:var(--faint);white-space:nowrap;
...
.nav-island.topbar{position:fixed;top:14px;left:50%;transform:translateX(-50%);width:min(680px, calc(100vw - 28px));height:64px;min-height:64px;box-sizing:border-box;padding:0 20px;border-radius:999px;display:flex!important;align-items:center;justify-content:space-between;background:rgba(10,12,14,.94);backdrop-filter:blur(24px) saturate(160%);-webkit-backdrop-filter:blur(24px) saturate(160%);border:1px solid rgba(255,255,255,.09);box-shadow:0 16px 36px rgba(0,0,0,.6);z-index:100}
.nav-island.topbar .logo{font-family:Archivo,sans-serif;font-variation-settings:'wdth' 125,'wght' 900;font-size:15.5px;text-transform:uppercase;color:#fff;display:flex;align-items:center;gap:9px;text-decoration:none}
.nav-island.topbar .logo .ic{color:var(--lime);width:23px;height:23px}
.nav-profile-btn{width:40px;height:40px;border-radius:50%;overflow:hidden;border:1.5px solid var(--lime);display:flex;align-items:center;justify-content:center;flex-shrink:0;text-decoration:none;background:rgba(255,255,255,.05);box-shadow:0 0 14px rgba(196,248,42,.25);transition:transform .2s ease,border-color .2s ease}
.nav-profile-btn:hover{transform:scale(1.08);border-color:#fff}
.nav-avatar-img{width:100%;height:100%;object-fit:cover;display:block}
body.app main,body.app .kc-home-wrap,body.app .kc-ex-wrap,body.app .kc-wallet-wrap,body.app .kc-profile-wrap,body.app .kc-trade-wrap,body.app .kc-assets-wrap,body.app .wrap{padding-top:92px!important}
body.app .taskbar ~ footer{padding-bottom:104px}
@media (max-width:768px){
  .nav-island.topbar{top:max(8px,env(safe-area-inset-top));left:10px;right:10px;transform:none;width:auto;max-width:calc(100vw - 20px)!important;height:60px;min-height:60px;padding:0 16px}
  body.app main,body.app .kc-home-wrap,body.app .kc-ex-wrap,body.app .kc-wallet-wrap,body.app .kc-profile-wrap,body.app .kc-trade-wrap,body.app .kc-assets-wrap,body.app .wrap{padding-top:84px!important}
