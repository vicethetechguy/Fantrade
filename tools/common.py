...
.taskbar{position:fixed;left:50%;bottom:0;transform:translateX(-50%);z-index:75;
  display:grid;grid-template-columns:repeat(5,1fr);align-items:center;
  width:100%;max-width:680px;height:58px;box-sizing:border-box;
  background:rgba(8,9,10,.96);backdrop-filter:blur(24px) saturate(160%);
  -webkit-backdrop-filter:blur(24px) saturate(160%);
  border-top:1px solid rgba(255,255,255,.08);box-shadow:0 -4px 24px rgba(0,0,0,.6);
...
.taskbar a{display:flex;flex-direction:column;align-items:center;justify-content:center;
  gap:3px;height:100%;color:#767c82;text-decoration:none;
...
.taskbar .tb-badge{position:absolute;top:-4px;right:-10px;background:#FF3B47;color:#fff;
  font-family:'JetBrains Mono',monospace;font-size:9px;font-weight:700;
  min-width:14px;height:14px;border-radius:999px;display:flex;
  align-items:center;justify-content:center;padding:0 3px;
  border:1.5px solid #08090a}
.taskbar ~ footer{padding-bottom:calc(80px + env(safe-area-inset-bottom, 0px))}
.taskbar ~ .ft-toast-container{bottom:calc(70px + env(safe-area-inset-bottom, 0px))}
...
TASKBAR = [("dashboard.html", "Home", "home"),
           ...
           ("trade.html", "Trade", "swap"),
           ("fanplay.html", "Futures", "candle"),
           ("account.html", "Assets", "wallet")]
...
TAB_OF = {"dashboard.html": "dashboard.html", "clubs.html": "dashboard.html",
          ...
          "trade.html": "trade.html", "club-builder.html": "dashboard.html",
          "divisions.html": "dashboard.html",
...
def taskbar(current=""):
    """Dock five-item bottom bar — styled exactly like the KuCoin mobile bar with Fantrade brand colors."""
...
var ASSETS=[
 {t:'SOL',n:'Solana',p:102.65,d:2.96,c:false,cap:'39.24M',h:104.82,low:99.21,q:'USDT',vol:'384.44K',tag:'10x'},
 {t:'SUI',n:'SUI',p:0.7197,d:2.21,c:false,cap:'12.48M',h:0.74,low:0.69,q:'USDT',vol:'85.2M',tag:'10x'},
 {t:'XRP',n:'Ripple',p:1.41903,d:5.46,c:false,cap:'106.36M',h:1.45,low:1.38,q:'USDT',vol:'106.36M',tag:'10x'},
 {t:'DOGE',n:'Dogecoin',p:0.08377,d:1.28,c:false,cap:'7.13M',h:0.089,low:0.081,q:'USDT',vol:'7.13M',tag:'10x'},
 {t:'BTC',n:'Bitcoin',p:77979.9,d:1.60,c:false,cap:'375.81M',h:78450.0,low:76800.0,q:'USDT',vol:'375.81M',tag:'Perp'},
 {t:'ETH',n:'Ethereum',p:2515.18,d:1.30,c:false,cap:'407.36M',h:2560.0,low:2480.0,q:'USDT',vol:'407.36M',tag:'Perp'},
 {t:'$Saka',n:'Bukayo Saka',p:48.20,d:6.4,c:false,cap:'482.0M',h:51.2,low:46.8,q:'FTR',vol:'12.4M',tag:'10x'},
 {t:'$Haaland',n:'Erling Haaland',p:71.40,d:-1.8,c:false,cap:'714.0M',h:74.0,low:70.1,q:'FTR',vol:'18.6M',tag:'10x'},
 {t:'$Bruno',n:'Bruno Fernandes',p:39.75,d:2.1,c:false,cap:'397.5M',h:41.8,low:38.5,q:'FTR',vol:'9.8M',tag:'10x'},
 {t:'$Vinicius',n:'Vinícius Júnior',p:63.10,d:0.7,c:false,cap:'631.0M',h:65.0,low:62.0,q:'FTR',vol:'15.2M',tag:'10x'},
 {t:'$Bellingham',n:'Jude Bellingham',p:58.90,d:3.3,c:false,cap:'589.0M',h:61.0,low:57.2,q:'FTR',vol:'14.1M',tag:'10x'},
 {t:'$Musiala',n:'Jamal Musiala',p:46.70,d:5.1,c:false,cap:'467.0M',h:48.5,low:44.2,q:'FTR',vol:'11.5M',tag:'10x'},
 {t:'$Pedri',n:'Pedri González',p:41.15,d:-0.9,c:false,cap:'411.5M',h:42.5,low:40.1,q:'FTR',vol:'8.9M',tag:'10x'},
 {t:'$Saliba',n:'William Saliba',p:33.80,d:2.7,c:false,cap:'338.0M',h:35.0,low:32.4,q:'FTR',vol:'7.2M',tag:'10x'},
 {t:'$Jackson',n:'Nicolas Jackson',p:14.85,d:11.2,c:false,cap:'148.5M',h:15.5,low:13.2,q:'FTR',vol:'5.4M',tag:'10x'},
 {t:'$Arteta',n:'Mikel Arteta',p:22.05,d:4.9,c:true,cap:'220.5M',h:23.5,low:21.0,q:'FTR',vol:'6.1M',tag:'COACH'},
 {t:'$Pep',n:'Pep Guardiola',p:29.60,d:-0.4,c:true,cap:'296.0M',h:30.8,low:28.9,q:'FTR',vol:'7.8M',tag:'COACH'},
 {t:'$Maresca',n:'Enzo Maresca',p:18.30,d:1.2,c:true,cap:'183.0M',h:19.2,low:17.8,q:'FTR',vol:'4.5M',tag:'COACH'}
];
