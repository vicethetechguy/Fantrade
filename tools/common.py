...
body.app main{padding-top:86px!important}
...
@media (max-width:768px){
  .nav-island.topbar{top:max(8px,env(safe-area-inset-top));left:10px;right:10px;transform:none;width:auto;max-width:calc(100vw - 20px)!important;height:58px;min-height:58px;padding:0 16px}
  body.app main{padding-top:74px!important}
  body.app .kc-home-wrap,body.app .kc-ex-wrap,body.app .kc-wallet-wrap,body.app .kc-profile-wrap,body.app .kc-trade-wrap,body.app .kc-assets-wrap,body.app .wrap{padding-top:0!important}
  body.app .app-head,body.app .phead{padding:12px 0 14px}
  body.app .pad{padding:14px 13px}
  body.app section{padding:12px 0}
}
"""
