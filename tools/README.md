...
The nineteen HTML pages in the repository root are generated, not hand-edited.
...
```bash
cd tools && python3 pages.py && python3 pages2.py && python3 pages3.py && python3 pages4.py
```

All four scripts write to the repository root. Edit the generators, not the HTML, or the next
